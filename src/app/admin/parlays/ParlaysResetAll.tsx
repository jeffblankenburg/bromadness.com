            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-zinc-300">
                  This will permanently delete <span className="text-red-400 font-semibold">all parlays and their picks</span> for all players in this tournament. This action cannot be undone.
                </p>
              </div>
