...
export function BrocketSettings({ tournamentId, entryFee: initialEntryFee, enabled: initialEnabled, lockIndividual: initialLockIndividual }: Props) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-zinc-900 border border-zinc-700 rounded-xl p-6 w-full max-w-sm space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-orange-400 uppercase tracking-wide" style={{ fontFamily: 'var(--font-display)' }}>Brocket Settings</h3>
              <button
                onClick={() => setIsOpen(false)}
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-zinc-300">Enable Brocket</span>
                </label>
              </div>
              ...
              <div className="text-xs text-zinc-500">
                Payouts: 50% / 30% / 20% for 1st / 2nd / 3rd place
              </div>
