  ...
  },
  {
    ...
    icon: (isActive: boolean) => (
      <img
        ...
        style={{
          filter: isActive
            ? 'brightness(0) saturate(100%) invert(64%) sepia(54%) saturate(2067%) hue-rotate(340deg) brightness(100%) contrast(97%)'
            : 'brightness(0) saturate(100%) invert(47%) sepia(6%) saturate(374%) hue-rotate(201deg) brightness(94%) contrast(86%)'
        }}
      />
    ),
  },
...
export function BottomNav() {
  ...
  return (
    <nav className="sticky bottom-0 z-50 bg-zinc-900/95 backdrop-blur border-t border-zinc-800 pb-safe">
